...
import sys
sys.path.append('../')
# from utils.DSen2Net_original import s2model
...
def _predict(test, input_shape, deep=False, run_60=False):
    ...
    if deep:
        ...
        predict_file = MDL_PATH+'s2_030_lr_1e-05.hdf5' if run_60 else '……/SR_ISS/data/network/s2_038_cbam_bigdatalr_1e-04.hdf5'
